                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-5 text-center mx-auto">
                            <h1 className="text-white mb-2 mt-5">Bem vindo!</h1>
                            <p className="text-lead text-white">Crie sua conta.</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div className="card-body">
                                <div className="mb-3">
                                    <input type="text" value={nome}
                                           ...
                                           required className="form-control" placeholder="Nome"
                                           aria-label="Nome"/>
                                </div>
                                <div className="mb-3">
                                ...
                                <div className="form-check form-check-info text-start">
                                    ...
                                    <label className="form-check-label" htmlFor="flexCheckDefault">
                                        Eu concordo com <a href="javascript:;" className="text-dark font-weight-bolder">Termos
                                        e condições</a>
                                    </label>
                                </div>
                                <div className="text-center">
                                    <button onClick={handleSubmit} type="button" className="btn bg-gradient-dark w-100 my-4 mb-2">Registrar
                                    </button>
                                </div>
                                <p className="text-sm mt-3 mb-0">Já tem uma conta? <Link to="/login"
                                                                                         className="text-dark font-weight-bolder"> Faça
                                    login</Link></p>
                            </div>
                        </div>
                    </div>
